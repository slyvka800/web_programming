import { onEditItem, onRemove } from "./index.js";
...
<li id="${id}" class="card mb-3 item-card" draggable="true">
    ...
    <div class="card-body">
        ...
        <button id="${DELETE_BUTTON_PREFIX}${id}" type="button" class="btn btn-danger">
            Delete
        </button>
    </div>
</li>`
...
export const addItemsToPage = ({ id, name, passengers, fuel }) => {
    ...
    // element.onmousedown = onDragNDrop(element, onRemove)
